# -*- coding: utf-8 -*-
"""catboost_multi(0808).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PwipSI-MIvAeJBiXy5a81FJZLwghhwW0
"""
"""# Import & Install"""
...
for offset in range(1, 8):
    ...
    df_off = df_train[df_train['predict_date_offset'] == offset]
    ...
    models[offset] = model
    train_sets[offset] = (x_train, y_train)
    val_sets[offset]   = (x_val, y_val)

rmse_results = []

for offset, model in models.items():
    X_val, y_val = val_sets[offset]
...
rmse_df = pd.DataFrame(rmse_results).sort_values('offset').set_index('offset')
...
for offset, model in models.items():
    mask = df_test['predict_date_offset'] == offset

    X_test_offset = df_test.loc[mask, features]

    df_test.loc[mask, '매출수량'] = model.predict(X_test_offset)
